...
namespace ProjektWypozyczalnia.Areas.Admin.Controllers
{
    ...
    public class StatusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Code,Description")] Status status)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Code,Description")] Status status)
        {
            if (id != status.Id)
            {
                return NotFound();
